...
<div class="ui segment blue">
	...
	<div class="uk-margin-top" style="margin-left: 10px;">
		<table class="ui small table color blue selectable stripped">
			...
			<tbody>
				<?php foreach(Invoice::getAll()->data as $item) { ?>
					<tr>
						<td>
						...
						<td>
							<a class="ui mini basic circular icon button purple zn-link-print" data-href="print-invoice?type=1&id=<?=$item['sale']?>">
