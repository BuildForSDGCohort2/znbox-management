...
<div class="ui segment blue">
	<div class="uk-padding-small">
		...
		<a class="ui basic button blue zn-link-dialog" href="customer/add_form"><i class="ui plus icon"></i> <?=Translator::translate('Add customer')?></a>
			...
			<tbody>
				<?php foreach(Customer::getAll()->data as $item) { ?>
					<tr>
						...
						<td><?= $item['address'] ?></td>
						<td>
							<a class="ui mini basic circular icon button blue zn-link-dialog" href="customer/view" data="<?=$item['id']?>" data-tooltip="<?=Translator::translate("view details")?>">
								<i class="ui eye icon"></i>
							</a>
							<a class="ui mini basic circular icon button green zn-link-dialog" href="customer/edit_form" data="<?=$item['id']?>" data-tooltip="<?=Translator::translate("edit details")?>">
								<i class="ui edit icon"></i>
							</a>
							<a class="ui mini basic circular icon button red zn-link-dialog" href="customer/delete_form" data="<?=$item['id']?>" data-tooltip="<?=Translator::translate("delete")?>">
