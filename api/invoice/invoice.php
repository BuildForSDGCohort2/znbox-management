...
<div class="ui segment blue">
	<div class="uk-padding-small">
		<div class="ui header dividing color blue">
			<h3 class="ui header blue"><i class="ui cart icon"></i> <?=Translator::translate("Invoices")?></h3>
		</div>
	</div>
	<div class="uk-margin">
	...
	<div class="uk-margin-top" style="margin-left: 10px;">
		<table class="ui small table color blue inverted selectable stripped">
			...
			<tbody>
				<?php foreach(Invoice::getAll() as $item) { ?>
					<tr>
						<td>
						...
						<td>
							<label class="ui label mini blue">
								<?=Helper::formatNumber(Invoice::getTotal($item["id"]))?>
							</label>		
						</td>
						<td>
							<a class="ui mini circular icon button purple zn-link-print" data-href="<?=Helper::url("print-invoice?type=1&id=".$item["sale"])?>">
