...
?>
<form class="ui small modal form zn-form" action="<?=Helper::url("api/sale/generate_proforma.php")?>" data="<?=$_GET["id"]?>">
    <div class="header">
        <h3 class="ui header red"><?=Translator::translate("Confirm to generate proforma")?></h3>
    </div>
    <div class="content">
        <div class="ui form">
            <div class="ui field">
                <label><?=Translator::translate("proforma date");?></label>
                <input class="flatpickr" value="<?=date("Y-m-d")?>" type="date" name="value[date_emitted]">
            </div>
            <div class="ui field">
                <label><?=Translator::translate("proforma due date");?></label>
